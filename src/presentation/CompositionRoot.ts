...
import { StagedRolloutD2ApiRepository } from "../data/staged-rollout/StagedRolloutD2ApiRepository";
...
import { GetStagedRolloutsUseCase } from "../domain/staged-rollout/usecases/GetStagedRolloutsUseCase";
...
export class CompositionRoot {
    ...
    constructor(public readonly localInstance: Instance, encryptionKey: string) {
        ...
        this.repositoryFactory.bind(Repositories.StagedRolloutRepository, StagedRolloutD2ApiRepository);
    }
    ...
    @cache()
    public get stagedRollouts() {
        return getExecute({
            get: new GetStagedRolloutsUseCase(this.repositoryFactory, this.localInstance),
        });
    }
}
